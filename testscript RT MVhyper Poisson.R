...
source("NimbleModelRT MVhyper Poisson.R")
source("NimbleFunctionsRT MVhyper Poisson.R")
...
data <- sim.RT.MVhyper(N=N,lam0=lam0,sigma=sigma,K=K,X=X,buff=buff,n.select=n.select,obstype="poisson")
...
nimbuild <- init.RT.MVhyper(data,inits,M=M,obstype="poisson")
