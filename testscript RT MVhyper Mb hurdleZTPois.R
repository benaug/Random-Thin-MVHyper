...
source("NimbleModelRT MVhyper Mb hurdleZTPois.R")
source("NimbleFunctionsRT MVhyper Mb hurdleZTPois.R")
...
conf$removeSampler(c("p0.p","p0.c","sigma"))
conf$addSampler(target = c("p0.p","p0.c","sigma"),
                  type = 'AF_slice',
